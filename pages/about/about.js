...
Page({
  ...
  chooseImg() {
    wx.chooseImage({
      ...
      success: res => {
        ...
        this.imgTransFormBase64(res.tempFilePaths[0])
  ...
  cartoonImg(data) {
    console.log(data)
    wx.request({
url:'https://aip.baidubce.com/rest/2.0/image-process/v1/colourize?access_token=' + this.data.access_token,
      header: {
